...
class Chef
  class Resource::GraphiteWeb < Chef::Resource
    ...
    attribute(:remote_find_timeout, kind_of: [ Fixnum, Float ], config_attribute: true)
    attribute(:remote_fetch_timeout, kind_of: [ Fixnum, Float ], config_attribute: true)
    attribute(:remote_retry_delay, kind_of: [ Fixnum, Float ], config_attribute: true)
    ...
    attribute(:remote_render_connect_timeout, kind_of: [ Fixnum, Float ], config_attribute: true)
    attribute(:carbonlink_hosts, kind_of: Array, config_attribute: true)
    attribute(:carbonlink_timeout, kind_of: [ Fixnum, Float ], config_attribute: true)
